...
<q-span>Десятинная церковь была построена в честь:</q-span>
<div class="option row">
   <q-radio class="col-12"
      v-model="selected"
      val="option1"
      label="крещения Руси "
    />
    ...
    <q-radio class="col-12"
      v-model="selected"
      val="option2"
      label="объединения Новгорода и Киева "
    />
    
    <q-radio class="col-12"
      v-model="selected"
      val="option3"
      label="победы над хазарами  "
    />

    <q-radio class="col-12"
      v-model="selected"
      val="option4"
      label="победы над печенегами"
    />
