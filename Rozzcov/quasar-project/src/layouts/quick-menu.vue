...
`, path: "/tests"
      ...
      {
        title: "наставничество", image: `  <defs>
    <style>
      .cls-1 {
        fill-rule: evenodd;
      }
...
<template>
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      ...
      <q-btn @click="toggleDrawer" icon="menu" flat round class="q-mr-md menu_burger" />

      <q-drawer v-model="drawerState" show-if-above :breakpoint="lg" :width="320">
        <div class="menu_user">
          <div class="ro_logo">
          ...
          <div class="container">
            ...
            <div class="menu">
              <nav class="nav_menu">
                <ul>
                  ...
                  <li class="nav_li" v-for="item in menuNav" :key="item.id"><button @click="$router.push(item.path)">
                      <svg width="21" height="21" viewBox="0 0 500 500" v-html="item.image"></svg> <span>{{ item.title
                        }}</span></button></li>
                </ul>
              </nav>
            </div>
            <div class="social_media">
              ...
              <div class="social_media_block">
                <div class="social_media_youtube"><img class="youtube" src="src/assets/icons/youtube.svg" width="40px"></div>
                <div class="social_media_vk"><img src="src/assets/icons/vk.svg" width="43px"></div>
              </div>
            </div>
          </div>
        </div>
