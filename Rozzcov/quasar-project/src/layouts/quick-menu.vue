    ...
    <div class="menu_user">
        ...
        <nav class="nav_menu">
            <ul>
                ...
                <li class="nav_li" v-for="item in menuNav" :key="item.id"><button> <svg width="21" height="21" viewBox="0 0 500 500"  v-html="item.image"></svg> <span>{{ item.title }}</span></button></li>
            </ul>
        </nav>
    </div>
